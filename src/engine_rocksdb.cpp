...
void ustore_database_init(ustore_database_init_t* c_ptr) {
    ...
    safe_section("Opening RocksDB", c.error, [&] {
        ...
        // Load from file - temporarily disabled due to API changes
        // auto config_file = config.engine.config_file_path;
        // if (!config_file.empty()) {
        //     rocksdb::ConfigOptions config_options;
        //     status = rocksdb::LoadOptionsFromFile(config_options, config_file, &options, &column_descriptors);
        ...
        //     *c.error = "Recovering RocksDB state";
        //     return;
        // }
